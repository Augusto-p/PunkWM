function updateWorkspaces(workspace) {
    ...
    function getGhostColor() {
        const Colors = ["#04D9D9", "#F28705", "#F21905", "#F2ACAC"]
    ...
    function getModeImage(mode) {
        switch (mode) {
            case 0:
                return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" class="Dot"><circle cx="15" cy="15" r="15"/></svg>`
                break;
            case -1:
                return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 541.6 571.11"><path fill="#FFFF01" d="M535.441,412.339A280.868,280.868 0 1,1 536.186,161.733L284.493,286.29Z" /></svg>`
                break;

            default:
                return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 333.561 333.561" fill="${getGhostColor()}">
