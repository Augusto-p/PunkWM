...
impl ConfigGoogle {
    pub fn get_credentials_file(&self)->&String{&self.credentials_file}

    pub fn get_credenciales(&self)->String{
    ...
    pub fn get_events(&self)->u16{self.max_events_view.clone()}

    pub fn get_scopes(&self)->Vec<String>{self.scopes.clone()}
